...
headers = {
    'Referer': 'http://music.163.com/song?id=5279721',
...
#proxies = {'http':'http://222.76.187.120:8118','https':'https://113.200.241.202:63000'}
...
if __name__ == "__main__":
    ...
    url = "http://music.163.com/weapi/v1/resource/comments/R_SO_4_5279721?csrf_token="
    page = get_page(url)
    for i in range(page):
        params = get_params(i);
        encSecKey = get_encSecKey();
