...
def get_and_save_top_keywords(count,songid,songname,songsinger):
    dic_keywords = {}
    ...
    print('爬取部分已经完成')
    print("曲名：",songid)
    fhandle=open('./xiaoya/'+str(count)+"."+str(songname)+" "+str(songsinger)+" "+str(songid),'a')  #写入文件
...
if __name__ == '__main__':
    ...
    get_and_save_top_keywords(count,songid,songname,songsinger)
    '''
